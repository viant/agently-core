...
func TestServiceMethodsExposeReportingSurface(t *testing.T) {
	...
	require.Equal(t, "record_audit_event", signatures[2].Name)
	require.Equal(t, "share_artifact", signatures[3].Name)
	require.Equal(t, "transition_artifact", signatures[4].Name)
	require.Equal(t, "export_report", signatures[5].Name)
	require.Equal(t, "submit_export", signatures[6].Name)
	require.Equal(t, "get_export_status", signatures[7].Name)
	require.Equal(t, "list_export_jobs", signatures[8].Name)
	require.Equal(t, "list_export_artifacts", signatures[9].Name)
	require.Equal(t, "get_artifact", signatures[10].Name)
	require.Equal(t, "get_shared_artifact", signatures[11].Name)
	require.Equal(t, "list_shared_artifacts", signatures[12].Name)
	require.Equal(t, "save_report", signatures[13].Name)
	require.Equal(t, "get_report", signatures[14].Name)
	require.Equal(t, "list_reports", signatures[15].Name)
	require.Equal(t, "update_report", signatures[16].Name)
