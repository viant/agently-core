...
func TestService_extendPlanFromResponse_RejectsDuplicateMessageShowContinuationCalls(t *testing.T) {
	ctx := context.Background()
	service := &Service{}
	aPlan := execution.New()
	genInput := &core2.GenerateInput{
					...
					ToolCalls: []llm.ToolCall{
						{
							...
							Arguments: map[string]interface{}{
								"messageId": "source-msg",
								"byteRange": map[string]interface{}{"from": 57600, "to": 65912},
							},
						},
						{
							ID:   "call-3",
							...
							Arguments: map[string]interface{}{
								"messageId": "source-msg",
								"byteRange": map[string]interface{}{"from": 65912, "to": 74224},
							},
						},
					},
				},
...
func TestService_extendPlanFromResponse_RejectsWrongMessageShowContinuationArgs(t *testing.T) {
	ctx := context.Background()
	service := &Service{}
	aPlan := execution.New()
	genInput := &core2.GenerateInput{
...
func TestService_extendPlanFromResponse_AllowsSingleExactMessageShowContinuationCall(t *testing.T) {
	ctx := context.Background()
	service := &Service{}
	aPlan := execution.New()
	genInput := &core2.GenerateInput{
