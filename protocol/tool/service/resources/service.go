...
func (s *Service) Methods() svc.Signatures {
	return []svc.Signature{
		...
		{Name: "readImage", Description: "Read an image by absolute URI/path (including scratchpad://artifact/id), or a root-relative path, and present it as native vision input on the next model call. Defaults to resizing to fit 2048x768.", Input: reflect.TypeOf(&ReadImageInput{}), Output: reflect.TypeOf(&ReadImageOutput{})},
