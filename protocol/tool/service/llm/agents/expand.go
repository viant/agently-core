...
func (s *Service) expandMessages(ctx context.Context, msgs []intent.Message, objective string, cfg *intent.Expansion) []intent.Message {
...
func (s *Service) callExpansionSidecar(ctx context.Context, msgs []intent.Message, objective string, cfg *intent.Expansion) ([]intent.Message, error) {
...
func parseExpansionOutput(raw string) ([]intent.Message, error) {
	raw = stripMarkdownFence(raw)
	var out []intent.Message
...
func validExpansionOutput(out, original []intent.Message) bool {
