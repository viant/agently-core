...
type Goal = api.Goal
type GoalControllerSchedule = api.GoalControllerSchedule
type GoalEnvelope = api.GoalEnvelope
type ListAsyncOperationsInput = api.ListAsyncOperationsInput
type ListAsyncOperationsOutput = api.ListAsyncOperationsOutput
type CreateGoalInput = api.CreateGoalInput
type UpdateGoalInput = api.UpdateGoalInput
...
type WorkspaceAssetDescriptor = api.WorkspaceAssetDescriptor
type WorkspaceComposer = api.WorkspaceComposer
