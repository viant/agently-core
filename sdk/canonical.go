...
type RenderedContent = api.RenderedContent
type RenderedContentPart = api.RenderedContentPart
type RenderedData = api.RenderedData
type RenderedReport = api.RenderedReport
type RenderedReportTarget = api.RenderedReportTarget
