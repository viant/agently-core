...
@Serializable
data class ApprovalForgeView(
    val windowRef: String? = null,
    val containerRef: String? = null,
    val dataSource: String? = null,
    val callbacks: List<ApprovalCallback> = emptyList()
)

@Serializable
data class ApprovalMeta(
    val type: String? = null,
    val toolName: String? = null,
    val title: String? = null,
    val message: String? = null,
    ...
    val editors: List<ApprovalEditor> = emptyList(),
    val forge: ApprovalForgeView? = null
)
...
@Serializable
data class PendingToolApprovalPage(
    val rows: List<PendingToolApproval> = emptyList(),
    val total: Int = 0,
    val offset: Int = 0,
    val limit: Int = 0,
    val hasMore: Boolean = false
